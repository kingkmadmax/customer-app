      ...
      {step !== "done" ? (
          ...
          <div className="relative">
            <div className="w-full h-64 bg-gray-950 rounded-[2rem] overflow-hidden border-4 border-white shadow-xl relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div
                  className={`w-44 h-44 border-2 border-dashed border-white/30 rounded-full flex items-center justify-center transition-all ${stream ? "scale-100 opacity-40" : "scale-90 opacity-0"}`}
                >
            ...
            <div className="absolute bottom-4 inset-x-0 flex justify-center">
              {!stream ? (
                <button
                  type="button"
                  onClick={() =>
                    startCamera(step === "face" ? "user" : "environment")
                  }
          ...
          <div className="p-4 bg-blue-50/50 rounded-2xl border border-blue-100 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 leading-tight">
                Position the {step === "face" ? "face" : "ID card"} clearly
                within the frame and tap capture.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-10 animate-in zoom-in text-center">
          ...
          <p className="text-[11px] text-gray-400 mt-1 uppercase">
            Hardware released. Images saved.
          </p>
